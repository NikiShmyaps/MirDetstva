              ...
              <ul className={cx("item-list")}>
                <li className={cx("item-list__item")}>
                  ...
                  <div className={cx("item-list__item-block")}>
                    ...
                    >
                      (бумажные стаканчики/тарелочки/салфетки/вилки)
                    </span>
                  </div>
                </li>
                  ...
                  <div className={cx("item-list__item-block")}>
                    ...
                    <ul className={cx("doplist")}>
                      <li className={cx("doplist-item")}>
                        &mdash; Шоу мыльных пузырей
                      </li>
                      <li className={cx("doplist-item")}>
                        &mdash; Челлендж рулетка
                      </li>
                      <li className={cx("doplist-item")}>
                        &mdash; Тик ток бум
                      </li>
                      <li className={cx("doplist-item")}>
                        &mdash; Пижамная вечеринка
                      </li>
                    </ul>
                  </div>
                </li>
              ...
              <ul className={cx("item-list")}>
                ...
                <li className={cx("item-list__item")}>
                  ...
                  <div className={cx("item-list__item-block")}>
                    ...
                    >
                      Автоматическая пушка, продолжительность 30&nbsp;мин
                    </span>
                  </div>
                </li>
              </ul>
